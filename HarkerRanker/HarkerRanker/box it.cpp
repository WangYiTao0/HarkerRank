...
//	long long CalculateVolume() { return  static_cast<long long> (l)* b * h; }; // Return the volume of the box
//
...
//
//	//Overload operator << as specified
//	friend ostream& operator<<(ostream& out, Box& B) { out << B.l << " " << B.b << " " << B.h; return out; }
//private:
//	int l, b, h;
//};
//
